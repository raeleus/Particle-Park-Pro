...
public class VelocitySubPanel extends Panel {
    public VelocitySubPanel() {
        ...
        tabTable.padRight(4);
        tabTable.left();
        var label = new Label("Velocity", skin, "header");
        ...
        addTooltip(spinner, "The high value for the particle speed in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The minimum high value for the particle speed in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The maximum high value for the particle speed in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The low value for the particle speed in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The minimum low value for the particle speed in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The maximum low value for the particle speed in world units per second", Align.top, tooltipBottomArrowStyle);
