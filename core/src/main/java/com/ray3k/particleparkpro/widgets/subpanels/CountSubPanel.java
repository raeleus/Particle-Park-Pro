...
public class CountSubPanel extends Panel {
    public CountSubPanel() {
        ...
        onChange(minSpinner, () -> UndoManager.add(new CountMinUndoable(minSpinner.getValueAsInt(), selectedEmitter.getMinParticleCount())));
        ...
        onChange(maxSpinner, () -> UndoManager.add(new CountMaxUndoable(maxSpinner.getValueAsInt(), selectedEmitter.getMaxParticleCount())));
    }
}
