...
public class GravitySubPanel extends Panel {
    public GravitySubPanel() {
        ...
        tabTable.padRight(4);
        tabTable.left();
        var label = new Label("Gravity", skin, "header");
        ...
        addTooltip(spinner, "The high value for the gravity strength in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The minimum high value for the gravity strength in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The maximum high value for the gravity strength in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The low value for the gravity strength in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The minimum low value for the gravity strength in world units per second", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The maximum low value for the gravity strength in world units per second", Align.top, tooltipBottomArrowStyle);
