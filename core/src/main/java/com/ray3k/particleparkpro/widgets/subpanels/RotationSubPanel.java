...
import static com.ray3k.particleparkpro.widgets.panels.EmitterPropertiesPanel.ShownProperty.ROTATION;
import static com.ray3k.particleparkpro.widgets.panels.EmitterPropertiesPanel.emitterPropertiesPanel;

public class RotationSubPanel extends Panel {
    public RotationSubPanel() {
        ...
        tabTable.padRight(4);
        tabTable.left();
        var label = new Label("Rotation", skin, "header");
        ...
        onChange(button, () -> {
            selectedEmitter.getRotation().setActive(false);
            emitterPropertiesPanel.removeProperty(ROTATION);
        });
        ...
        addTooltip(spinner, "The high value for the particle rotation in degrees", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The minimum high value for the particle rotation in degrees", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The maximum high value for the particle rotation in degrees", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The low value for the particle rotation in degrees", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The minimum low value for the particle rotation in degrees", Align.top, tooltipBottomArrowStyle);
        ...
        addHandListener(spinner.getButtonPlus());
        addHandListener(spinner.getButtonMinus());
        addTooltip(spinner, "The maximum low value for the particle rotation in degrees", Align.top, tooltipBottomArrowStyle);
